...
<form action="/JSPJFGL/Collage.jsp" name="form1" method="post" onSubmit="return check()">
	 <input type="hidden" name="method" value="upstu"><input type="hidden" name="id" value="<%=id %>">
                          ...
                          <td width="100%" >
                              <table width="59%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                  ...
                                  <td width="205"><INPUT type=text name=money size=30 maxlength=20 value=<%=list.get(4).toString() %>></td>
                                </tr> 
