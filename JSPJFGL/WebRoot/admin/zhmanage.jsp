              ...
              <br>
                ...
                <table width="700" cellspacing="0" cellpadding="0">
                  <tr><input type="hidden" name="hidden3" value="haha">
                    <td height="30" align="center" bgcolor="#EFF2F3" class="cd2"><p>序号</p></td>
                    <td align="center" bgcolor="#EFF2F3" class="cd1">帐号列表</td>
                    <td align="center" bgcolor="#EFF2F3" class="cd1">选择</td>
                  </tr>
                  <%
                    ...
                    <td height="8" align=center colspan="4" bordercolor="#5D8191" class="12txt18"><br>
                        <table align=center width="550" cellpadding="0" cellspacing="0">
                          <tr><input type="hidden" name="method" value="update">
                            <td align=center><input name="button1" type="button" value="修改密码" onclick="sub2()"></td>
