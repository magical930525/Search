...
<table align="center" width="100%" border=1 cellpadding="0" cellspacing="0">
  <tr>
     ...
     <td align="center"  height="30">值班教师</td>
     <td align="center"  height="30">开始时间</td>
     <td align="center"  height="30">结束时间</td>
     <td align="center"  height="30">修改</td>
     <td align="center"  height="30">删除</td>
  </tr>
  <%
  	List list=new MachineBean().getAllZhiBan();
  	if(!list.isEmpty()){
  ...
  <tr>
     ...
     <td align="center"  height="30"><a href="/JSPJFGL/admin/upzhiban.jsp?id=<%=list2.get(0).toString()%>">修改</a></td>
     <td align="center"  height="30"><a href="/JSPJFGL/ZhiBan.jsp?id=<%=list2.get(0).toString()%>&method=delzhiban">删除</a></td>
  </tr> 
  <%} }%>                                        
</table>
<form action="/JSPJFGL/ZhiBan.jsp" name="form1" method="post" onSubmit="return check()"> 
<br><br><br>					<input type="hidden" name="method" value="addzhiban">
<table align="center" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td align="right"  height="30">值班教师:</td>
    <td align="left"  height="30"><INPUT type=text name=name size=30 maxlength=20 ></td>
  </tr>
  <tr>
    <td align="right"  height="30">开始时间:</td>
    <td align="left"  height="30"><INPUT type=text name=kaishi size=30 maxlength=20 ></td>
  </tr>
  <tr>
    <td align="right"  height="30">结束时间:</td>
    <td align="left"  height="30"><INPUT type=text name=jieshu size=30 maxlength=20 ></td>
  </tr>
  <tr>
