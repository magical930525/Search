...
<%String name=(String)session.getAttribute("Sname");
	if(name==null){
		...
		List list=new MachineBean().getWeiHu(Integer.parseInt(id));
 %>
<body >
<form action="/JSPJFGL/Machine.jsp" name="form1" method="post" onSubmit="return check()"> 
<br><br><br><input type="hidden" name="id" value="<%=id %>"><input type="hidden" name="method" value="upweihu">
<table align="center" width="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td align="right"  height="30">维护设备:</td>
    <td align="left"  height="30"><INPUT type=text name=shebei size=30 maxlength=20 value=<%=list.get(1).toString() %>></td>
  </tr>
  <tr>
    <td align="right"  height="30">维护原因:</td>
    <td align="left"  height="30"><INPUT type=text name=yuanyin size=30 maxlength=20  value=<%=list.get(2).toString() %>></td>
  </tr>
  <tr>
    <td align="right"  height="30">维护费用:</td>
    <td align="left"  height="30"><INPUT type=text name=weihu size=30 maxlength=20  value=<%=list.get(3).toString() %>></td>
  </tr>
  <tr>
    <td align="right"  height="30">维护时间:</td>
    <td align="left"  height="30"><INPUT type=text name=shijian size=30 maxlength=20  value=<%=list.get(4).toString() %>></td>
  </tr> 
  <tr>
