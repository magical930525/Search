                          ...
                          <td width="100%" >
                              <table width="59%" cellpadding="0" cellspacing="0">
                                <tr>
                                  ...
                                  <td width="205"><INPUT type=text name=name size=30 maxlength=20></td>
                                </tr>
                                <tr>
                                  <td align="right"  height="30">学&nbsp;&nbsp;&nbsp;&nbsp;院:</td>
                                  <td width="205"><INPUT type=text name=xueyuan size=30 maxlength=20></td>
                                </tr>
                                  <tr>
                                  <td align="right"  height="30">系&nbsp;&nbsp;&nbsp;&nbsp;别:</td>
                                  <td width="205"><INPUT type=text name=xibie size=30 maxlength=20></td>
                                </tr>
                                <tr>
                                  <td align="right"  height="30">充值金额:</td>
                                  <td width="205"><INPUT type=text name=money size=30 maxlength=20><br><font color=red>教师卡不填此项目</font></td>
                                </tr> 
                               
                                <tr>
                                  <td align="right"  height="30">用户类型:</td>
                                  <td width="205"><select name=type >
                                  <option value="教师卡">教师卡</option>
                                  <option value="学生卡">学生卡</option>
                                  </select>
                                  </td>
                                </tr>               
                            </table></td>
