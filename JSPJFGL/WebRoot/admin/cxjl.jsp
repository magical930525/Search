...
<table align="center" width="100%" border=1 cellpadding="0" cellspacing="0">
  ...
  <tr>
     ...
     <td align="center"  height="30"><a href="/JSPJFGL/ZhiBan.jsp?id=<%=list2.get(0).toString()%>&method=deljilu">删除</a></td>
  </tr> 
  <%} }%>                                        
</table><br><br><br>
...
<td align="center">卡号<input type=text name=cardid size=15><input type=submit value="查询"></td>
</tr>
</table>
</form>
</body>
