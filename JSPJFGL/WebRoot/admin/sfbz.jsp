                    ...
                    <table align="center" width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td width="100%"  align="center">
                              <table align="center" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td align="center"  height="30">收费标准:<INPUT type=text name=biaozhun size=30 maxlength=20 value=<%=f %>>元/分钟</td>
                                </tr> 
                                <tr>
                                  <td  align="center"><input name="Submit32" type="submit" class="black12" value="确认">
                                  &nbsp;&nbsp;&nbsp;&nbsp;<input name="Submit3" type="reset" class="black12" value="重填"></td>
                                </tr>                                      
                            </table></td>
                        </tr>
