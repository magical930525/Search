  ...
  <tr>
    <td height="121" align="center" valign="top" bgcolor="#FFFFFF"><div align="left"><br>
                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="center" bgcolor="#EFF2F3" class="cd1">系别</td>
                     <td align="center" bgcolor="#EFF2F3" class="cd1">余额</td>
                    <td align="center" bgcolor="#EFF2F3" class="cd1">充值金额</td>
                    <td align="center" bgcolor="#EFF2F3" class="cd1">类型</td>
                    <td align="center" bgcolor="#EFF2F3" class="cd1">注册时间</td>
                    <td align="center" bgcolor="#EFF2F3" class="cd1">充值</td>
                    <td align="center" bgcolor="#EFF2F3" class="cd1">充值记录</td>
				  ...
				  <td height="30" align="center" bgcolor="#FFFFFF" class="cd1"><%=list2.get(6).toString() %></td>
				  <td height="30" align="center" bgcolor="#FFFFFF" class="cd1"><%=list2.get(7).toString() %></td>					  
				  <td align="center" class="cd1"><a href="/JSPJFGL/admin/cz.jsp?id=<%=list2.get(0).toString().trim()%>">充值</a></td>
				  <td align="center" class="cd1"><a href="/JSPJFGL/admin/czjl.jsp?id=<%=list2.get(0).toString().trim()%>">充值记录</a></td>
				  <td align="center" class="cd1"><a href="/JSPJFGL/admin/upstu.jsp?id=<%=list2.get(0).toString().trim()%>">修改</a></td>
				  <td align="center" class="cd1"><a href="/JSPJFGL/Collage.jsp?id=<%=list2.get(0).toString().trim()%>&method=delstu">销卡</a></td>
				  </tr>	
	     <td align="center"  height="30">
     <%
     Float yu=Float.parseFloat(list2.get(4).toString())
     if(yu<=f){
     %>
     ...
     <%} %>
				  <%}%>
                  <tr>
                    <td height="2" colspan="11" align="left" bordercolor="#5D8191" bgcolor="#5D8191"></td>
                  </tr>
