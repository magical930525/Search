...
<%String name=(String)session.getAttribute("Sname");
	...
	List list=new CollageBean().getStu(Integer.parseInt(id));
 %>
<body >
<form action="/JSPJFGL/Collage.jsp" name="form1" method="post" onSubmit="return check()">
	 <input type="hidden" name="method" value="cz"><input type="hidden" name="id" value="<%=id %>">
                        ...
                        <tr>
                          <td width="100%" >
                              <table width="59%" cellpadding="0" cellspacing="0">
                                 <tr>
                                  <td align="right"  height="30">卡&nbsp;&nbsp;&nbsp;&nbsp;号:</td>
                                  <td width="205"><INPUT type=text name=xibie size=30 maxlength=20 value=<%=id %>></td>
                                </tr>
                                <tr>
                                  <td align="right"  height="30">当前金额:</td>
                                  <td width="205"><%=list.get(4).toString() %></td>
                                </tr> 
                                 <tr>
                                  <td align="right"  height="30">充值金额:</td>
                                  <td width="205"><INPUT type=text name=money size=30 maxlength=20 ></td>
                                </tr>            
                            </table></td>
                        </tr>
                        <tr>
